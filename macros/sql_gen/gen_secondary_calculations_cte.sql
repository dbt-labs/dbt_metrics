{% macro gen_secondary_calculation_cte(base_set, full_set, dimensions, grain, secondary_calculations, calendar_dimensions) %}
    {{ return(adapter.dispatch('gen_secondary_calculation_cte', 'metrics')(base_set, full_set, dimensions, grain, secondary_calculations, calendar_dimensions)) }}
{% endmacro %}

{% macro default__gen_secondary_calculation_cte(base_set, full_set, dimensions, grain, secondary_calculations, calendar_dimensions) %}
